...
Postal office of Manaia. Here is also a number of sending stones, engravings in a large stone wall that allow paying costumers to cast sending with a touch. 

**10g** per sending. 
Sending express mail is **100g** plus a distance fee. 
Sending secure (portable hole) is **500g**
Exchanging gems or other items (legal!) for gold is possible, **1% of the transaction value**.

For distance fee, see M_Orijin_GDPrices.png
